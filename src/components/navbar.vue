      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <b-nav-item class="top" to="/visual-demonstrations">
            <b-icon-image-alt class="h3 mb-0"></b-icon-image-alt>
            Visual Demonstrations
          </b-nav-item>
          <b-nav-item class="top" to="/bbs2">
            <b-icon-building class="h3 mb-0"></b-icon-building>
            BBS II Emden
          </b-nav-item>
      ...
      <b-collapse id="nav-collapse-bot" is-nav>
        <b-navbar-nav style="width: 100% !important" justified>
          ...
          <b-nav-item
            ...
            id="youtube"
            target="_blank"
            href="https://youtube.com/channel/UCz57bHmcp5TGRY6URQYWLkQ"
          >
            YOUTUBE
          </b-nav-item>
          <b-nav-item class="social" id="instagram" target="_blank" href="https://instagram.com/zlyfer/">
            INSTAGRAM
          </b-nav-item>
          ...
          <b-nav-item class="social" id="deviantart" target="_blank" href="https://deviantart.com/zlyfer">
            DEVIANTART
          </b-nav-item>
          <b-nav-item class="social" id="slyncarli" target="_blank" href="https://twitch.tv/slyncarli">
            TWITCH SLYNCARLI
          </b-nav-item>
          <b-nav-item class="social" id="zlyfah" target="_blank" href="https://twitch.tv/zlyfah">
            TWITCH ZLYFAH
          </b-nav-item>
        </b-navbar-nav>
      </b-collapse>
